...
def upgrade() -> None:
    ...
    sa.Column('esprit_id', sa.String(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('description', sa.String(), nullable=False),
    sa.Column('rarity', sa.String(), nullable=False),
    sa.Column('class_name', sa.String(), nullable=False),
    sa.Column('visual_asset_path', sa.String(), nullable=False),
    ...
    sa.Column('active_esprit_id', sa.String(), nullable=True),
    sa.Column('support1_esprit_id', sa.String(), nullable=True),
    sa.Column('support2_esprit_id', sa.String(), nullable=True),
    ...
    sa.Column('esprit_data_id', sa.String(), nullable=False),
