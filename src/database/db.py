...
# It goes up three levels from src/database/db.py -> src/database -> src -> PROJECT_ROOT
...
async def create_db_and_tables():
    ...
    async with engine.begin() as conn: # Use engine.begin() for transactional DDL
        await conn.run_sync(SQLModel.metadata.create_all) # Run the sync DDL operation on the connection
